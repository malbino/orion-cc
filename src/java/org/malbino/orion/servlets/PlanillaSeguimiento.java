...
public class PlanillaSeguimiento extends HttpServlet {
    ...
    public void generarPDF(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (id_grupo != null) {
            ...
            try {
                ...
                if (grupo.getGestionAcademica().getModalidadEvaluacion().equals(ModalidadEvaluacion.MODULAR)) {
    ...
    public PdfPTable pie(Grupo grupo) throws BadElementException, IOException {
        ...
        // fila 1
        cell = new PdfPCell(new Phrase("Nota Mínima: " + grupo.getGestionAcademica().getModalidadEvaluacion().getNotaMinimaAprobacion(), NORMAL));
        cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
        cell.setVerticalAlignment(PdfPCell.ALIGN_MIDDLE);
        cell.setColspan(15);
        table.addCell(cell);
