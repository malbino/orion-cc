 ...
 * @author tincho
 */
@WebServlet(name = "IngresosConceptoPago", urlPatterns = {"/reportes/ingresos/conceptoPago/IngresosConceptoPago"})
public class IngresosConceptoPago extends HttpServlet {
    ...
    public void generarPDF(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (id_gestionacademica != null && id_carrera != null && id_campus != null && id_conceptopago != null) {
            ...
            try {
                ...
                Logger.getLogger(IngresosConceptoPago.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public PdfPTable titulo(GestionAcademica gestionAcademica, Carrera carrera, Campus campus, ConceptoPago conceptoPago) throws BadElementException, IOException {
        ...
        cell = new PdfPCell(new Phrase("INGRESOS POR CONCEPTO DE PAGO,", TITULO));
